    ...
    return (
        Div(
            ...
            Div(
                        ...
                        Div(
                            ...
                            Div(
                                Label(
                                    ...
                                    ".",
                                    fr="terms",
                                    cls="font-light text-gray-500 dark:text-gray-300",
                                ),
                                cls="ml-3 text-sm",
                            ),
                ...
                cls="w-full mx-auto bg-white rounded-lg shadow dark:bg-gray-800 md:mt-0 sm:max-w-lg xl:p-0 lg:col-span-7 xl:col-span-6",
            ),
